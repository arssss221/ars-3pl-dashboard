...
export const employeeSeeds: EmployeeSeed[] = [
  ...
  },
  {
    ...
    phoneNo: '+8801711002233',
    phoneNo2: '+8801711002244',
    email: 'karim@arslogisticsmanager.com',
    occupationVisa: 'Driver',
    branch: 'Riyadh Main Operation',
    status: 'Working',
    vehicleNumber: 'KA-06-2211',
    iqamaNumber: 'IQ-623456',
    iqamaExpiry: '2027-10-18',
    ...
    sponsor: 'ARS Logistics Manager',
    accomodation: 'Company Housing',
    agreement: 'Complete',
    commitment: 'Complete',
    transferCount: '1',
    healthInsuranceName: 'Bupa Arabia',
    healthInsuranceExpiry: '2027-12-01',
    bankAccounts: [],
    documents: {
      selfie: true,
      iqama: true,
  ...
  },
  {
    ...
    idNumber: 'EMP007',
    nickName: 'Jamal',
    arabicName: 'جمال الدين',
    fullName: 'Jamal Uddin',
    phoneNo: '+8801811002233',
    phoneNo2: '+8801811002244',
    email: 'jamal@arslogisticsmanager.com',
    occupationVisa: 'Driver',
    branch: 'Riyadh Main Operation',
    status: 'Working',
    vehicleNumber: 'KA-07-3311',
    iqamaNumber: 'IQ-723456',
    iqamaExpiry: '2028-02-12',
    dateOfBirth: '1989-09-09',
    passportNo: 'G66778899',
    passportExpiry: '2030-04-14',
    nationality: 'Bangladeshi',
    ...
    transferCount: '0',
    healthInsuranceName: 'Tawuniya',
    healthInsuranceExpiry: '2028-01-19',
    bankAccounts: [],
    documents: {
      selfie: true,
      iqama: true,
  ...
  },
  {
    ...
    idNumber: 'EMP008',
    nickName: 'Sajid',
    arabicName: 'ساجد الرحمن',
    fullName: 'Sajid Rahman',
    phoneNo: '+8801911002233',
    phoneNo2: '+8801911002244',
    email: 'sajid@arslogisticsmanager.com',
    occupationVisa: 'Driver',
    branch: 'Dammam Delivery Zone',
    status: 'Working',
    vehicleNumber: 'KA-08-4411',
    iqamaNumber: 'IQ-823456',
    iqamaExpiry: '2027-07-28',
    dateOfBirth: '1993-12-21',
    passportNo: 'H66778899',
    ...
    transferCount: '0',
    healthInsuranceName: 'MedGulf',
    healthInsuranceExpiry: '2027-09-15',
    bankAccounts: [],
    documents: {
      selfie: true,
      iqama: true,
