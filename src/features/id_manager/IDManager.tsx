...
const initialIds: ManagedId[] = [
  ...
  },
  {
    ...
    owner: 'Jamal Uddin',
    idStatus: 'Active',
    phoneNumber: '+966544441111',
    email: 'jamal.daily@ars.com',
    password: 'Jamal@2026',
    note: 'Daily report import sample ID.',
  },
  {
    id: 5,
    platform: 'Daily Report',
    ...
    owner: 'Karim Hasan',
    idStatus: 'Active',
    phoneNumber: '+966544442222',
    email: 'karim.daily@ars.com',
    password: 'Karim@2026',
    note: 'Daily report import sample ID.',
  },
  {
    ...
    owner: 'Sajid Rahman',
    idStatus: 'Active',
    phoneNumber: '+966544443333',
    email: 'sajid.daily@ars.com',
    password: 'Sajid@2026',
    note: 'Daily report import sample ID.',
  },
];
